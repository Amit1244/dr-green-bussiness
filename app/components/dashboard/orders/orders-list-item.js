            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-6 gap-4 items-start">
                ...
                <div>
                    <Link href={`/dashboard/orders/${props.orderId}`}>
                        <button
                            className="w-full secondary-font uppercase py-3 px-6 rounded-[7px] bg-[#0aba90] border-[#0aba90] text-white text-lg sm:text-xl   leading-none shadow hover:shadow-[0_0_15px_0px_#0aba90] duration-200 ease-in-out"
                            title="ORDER DETAILS"
                        >
                            ORDER DETAILS
                        </button>
