        ...
        <div>
            ...
            <div className="relative mb-16 text-center">
                <div className="relative">
                    <button
                        className="w-full  secondary-font uppercase py-3 px-6 bg-[#0aba90] rounded-[7px] border-[#0aba90] text-white text-lg sm:text-xl md:text-3xl shadow hover:shadow-[0_0_15px_0px_#0aba90] duration-200 ease-in-out"
                        title="ADD TO CART"
                        onClick={cartHandler}
                    >
                        ADD TO CART
                ...
                {cartMessage && (
                    <Link href="/cart">
                        <button
                            className="w-full mt-10 secondary-font uppercase py-3 px-6 text-black rounded-[7px] bg-[#a9a9a9] text-lg sm:text-xl md:text-3xl shadow  duration-200 ease-in-out"
                            title="View Cart"
                        >
                            View Cart
                        </button>
