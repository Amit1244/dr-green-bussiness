            ...
            <>
                <div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {strains.map((strain, i) => (
                            ...
                            >
                                ...
                                <p className="text-[24px] sm:text-[30px] md:text-[36px] font-semibold text-center">
                                    {strain.name}
                                </p>
                                ...
                                <div className="flex justify-center">
                                    <Link href={`/product/${strain.id}`}>
                                        <button
                                            className="bg-primary text-white px-4 py-2 mt-3 sm:px-6 sm:py-3 rounded-full text-base sm:text-lg shadow-md hover:bg-green-700 transition duration-300"
                                            title="Discover"
                                        >
                                            Shop Now
                                        </button>
                    ...
                    <div className="text-center mt-6">
                        <button
                            className={`secondary-font uppercase cursor-pointer py-3 px-6 rounded-[7px]  border-black border-2 text-[#0aba90] text-lg sm:text-xl md:text-3xl shadow hover:shadow-[0_0_15px_0px_#08A47E] duration-200 ease-in-out ${count >= props.totalStrains ? "pointer-events-none" : ""
                                }
                    }`}
                            title={
