...
export default function CartClient(props) {
    ...
    return (
        <div className="grid xl:grid-cols-3 gap-8">
            <div className="xl:col-span-2">
                ...
                {cart?.cartItems && (
                    ...
                    >
                        CLEAR CART
                        <svg
                            className={`animate-spin ml-2 h-4 w-4 text-primary ${clearCartLoading ? "inline" : "hidden"
                                }`}
            ...
            <div className="rounded-[20px] border-2 border-[#808080] p-4 sm:p-8 flex flex-col justify-between items-start gap-16">
                <div>
