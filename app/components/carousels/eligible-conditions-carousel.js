    ...
    return (
        <div className="relative flex items-center gap-x-10 gap-y-8 flex-wrap lg:flex-nowrap">
            <button
                ...
                onClick={scrollPrev}
                ref={buttonPrev}
                className="min-h-[83px] min-w-[83px] rounded-full shadow hover:shadow-[0_0_15px_0px_#08A47E] duration-200 ease-in-out order-2 lg:order-1"
            >
                <Image
            ...
            <button
                ...
                onClick={scrollNext}
                ref={buttonNext}
                className="min-h-[83px] min-w-[83px] rounded-full shadow hover:shadow-[0_0_15px_0px_#08A47E] duration-200 ease-in-out order-3 lg:order-3"
            >
                <Image
