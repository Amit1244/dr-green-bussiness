...
export default async function Footer() {
    return (
        <footer className="relative pt-32 pb-4 sm:pb-10 xl:px-44 mt-5">
                ...
                <div className="grid lg:grid-cols-2 gap-x-8 gap-y-20 mt-16 sm:mt-20">
                    ...
                    <div>
                        ...
                        <div className="w-full flex flex-wrap gap-3 items-center justify-start sm:justify-center py-4">
                            ...
                            />
                            <button
                                className="uppercase py-4 px-6 mt-2 md:mt-0 rounded-full bg-[#0aba90] text-white border border-[#0aba90] text-[15px] shadow hover:shadow-[0_0_15px_0px_#0aba90] duration-200 ease-in-out"
