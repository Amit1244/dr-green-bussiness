        ...
        >
            ...
            <div className="flex justify-center items-center gap-4 flex-wrap">
                <button
                    type="submit"
                    title="Submit"
                    className={`secondary-font w-full md:w-max uppercase py-3 px-6 bg-primary text-white rounded-[7px] hover:bg-primary/90 text-lg sm:text-xl md:text-3xl shadow hover:shadow-[0_0_15px_0px_#0aba90] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center ${isPending ? "pointer-events-none" : ""
                        }`}
                >
                    Submit
                    <svg
