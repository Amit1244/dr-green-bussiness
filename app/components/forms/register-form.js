        ...
        >
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-4">
                <button
                    type="submit"
                    title="REGISTER"
                    className={`secondary-font uppercase w-full md:w-max py-3 px-6 rounded-[7px] bg-gray-200 text-gray-800 border-2 text-lg sm:text-xl md:text-3xl shadow duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center ${isPending ? "pointer-events-none" : ""
                        }`}
                >
                    REGISTER
                    <svg
                ...
                <p>Or</p>
                <Link className="w-full md:w-max" href="/login">
                    <button
                        title="LOGIN"
                        className="secondary-font w-full  uppercase py-3 px-6 rounded-[7px] bg-[#0aba90] border-[#0aba90] border-2 text-white text-lg sm:text-xl md:text-3xl shadow hover:shadow-[0_0_15px_0px_#0aba90] duration-200 ease-in-out"
                    >
                        LOGIN
                    </button>
                </Link>
