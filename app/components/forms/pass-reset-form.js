        ...
        >
            ...
            <div className="grid sm:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="password">
                        Enter New Password{" "}
                        <span className="text-[#08A47E]">*</span>
                    </label>
                    <div>
                        <input
                            maxLength={255}
            ...
            <div className="justify-center grid items-center">
                <button
                    ...
                    className={`secondary-font uppercase py-3 px-6 bg-[#08A47E] rounded-[7px] border border-[#08A47E] border-2 text-black text-3xl shadow hover:shadow-[0_0_15px_0px_#08A47E] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center ${isPending ? "pointer-events-none" : ""
                        }`}
                >
                    CONFIRM PASSWORD
                    <svg
            ...
            {state?.success && (
                <p className="text-[#08A47E] text-center">{state?.message}</p>
            )}
        </form>
    ) : (
        <form
        ...
        >
            ...
            <div className="justify-center grid items-center">
                <button
                    type="submit"
                    title="CONFIRM EMAIL"
                    className="secondary-font uppercase w-full md:w-max py-3 px-6 bg-[#0aba90] rounded-[7px] border-[#0aba90] text-white text-lg sm:text-xl md:text-3xl shadow hover:shadow-[0_0_15px_0px_#0aba90] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center"
                >
                    CONFIRM EMAIL
                    <svg
                        className={`animate-spin h-4 w-4 text-black ${isPending ? "inline" : "hidden"
