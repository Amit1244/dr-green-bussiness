    ...
    return (
        <main>
                ...
                <section className="relative pt-32 sm:pt-24 bg-gradient-to-b from-transparent to-white">
                    ...
                    <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                        ...
                        <div className="text-center mt-6 sm:mt-8">
                            <Link href="dashboard/cultivars">
                                <button className="bg-primary text-white px-4 py-2 sm:px-6 sm:py-3 rounded-full font-medium text-base sm:text-lg shadow-md hover:bg-green-700 transition duration-300">
                                    Shop Now
                                </button>
                            </Link>
                        </div>
            ...
            <div>
                ...
                <section className="text-center py-12 px-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        ...
                        <div className="flex flex-col items-center text-center bg-white p-6">
                            ...
                            <h3 className="text-lg font-medium mb-2">Title Goes Here</h3>
                ...
                <section className="relative text-white py-32 px-6 mx-2 sm:mx-8 rounded-2xl">
                    <div
            ...
            <div className="px-4 md:px-12 lg:px-20 py-20 md:py-24 space-y-12 max-w-7xl mx-auto">
                {/* Product Section */}
            ...
            <section className="relative pt-2 md:pt-40" id="faqs">
            ...
            <section className="py-28">
                <div className="container mx-auto xl:px-44 px-4">
                    <div>
                        <div className="flex items-center gap-x-4 text-start md:text-center">
                            <p className="text-xl md:text-[40px] font-medium ">
                                Something else on your mind? 🧐
                            </p>
                            <Link href="mailto:support@drgreennft.com">
                                <button
                                    className="py-3 px-6 font-normal  rounded-full bg-[#2b2b2b] text-[#fbfbfb] text-base md:text-[26px] duration-200 ease-in-out"
                                    title="Reach Out"
                                >
                                    Reach Out
                                </button>
            ...
            {/* <section className="mt-40 relative">
                <div className="container mx-auto px-4">
                    <div className="text-center">
                        <p className="text-lg font-semibold tracking-widest mb-8 text-[#08A47E]">
                            NEED A PRESCRIPTION?
                        </p>
                        ...
                        <Link href="/dashboard/eligibility">
                            <button
                                className="secondary-font uppercase py-3 px-6 bg-transparent rounded-[7px] border border-[#08A47E] border-2 text-[#08A47E] text-3xl shadow hover:shadow-[0_0_15px_0px_#08A47E] duration-200 ease-in-out"
                    ...
                    <div className="mx-auto sm:max-w-[80%] md:max-w-full backdrop-blur-[20px] rounded-[20px] border border-4 border-[#30e5f3] p-8 sm:p-16 mt-8 sm:mt-16 grid md:grid-cols-2 gap-8 sm:gap-16 items-center">
                        ...
                        <div>
                            ...
                            <Link href="#eligibile-conditions">
                                <button
                                    className="secondary-font uppercase py-3 px-6 bg-[#08A47E] rounded-[7px] border border-[#08A47E] border-2 text-black text-3xl shadow hover:shadow-[0_0_15px_0px_#08A47E] duration-200 ease-in-out"
            ...
            {/* <section className="mt-20 sm:mt-0">
                <div className="container mx-auto px-4">
                    <div>
                        <p className="text-[#08A47E] text-lg font-semibold tracking-widest mb-2">
                            NEWS / UPDATES
                        </p>
